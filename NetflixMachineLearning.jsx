NetflixMachineLearning = React.createClass({
		...
		return (
			...
			<section id="ml" className="main style2">
				<div className="container">
					...
					<p>Netflix has a long history of focusing on Machine Learning and AI to provide the best recommendations and user experience.  I have placed my focus on this area as well, in order to better understand and build the algorithms that will power the future.</p>
					</center>
