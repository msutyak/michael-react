AirbnbMachineLearning = React.createClass({
		...
		return (
			...
			<section id="ml" className="main style2">
				<div className="container">
					...
					<p>Airbnb is placing more of a <a href="https://www.theinformation.com/airbnb-joins-race-for-ai-talent">focus on Machine Learning and AI</a> in order to improve recommendations, and understand the context around traveler activities (i.e. traveling for a specific event, etc...).  These efforts tie back directly to improving the customer experience.  I am also focused on this area.</p>
					</center>
